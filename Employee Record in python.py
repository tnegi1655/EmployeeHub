...
def print():
    data=textarea.get(1.0,END)
    f='C:\\Users\\acer\\Projects\\python Project in GUI\\records\\'+str(ref_var.get())+'.txt'
...
F3.place(x=10,y=615,width=1260,height=100) # x and y specifies horizontal and vertical offsets in pixels.

btn1=Button(F3,text='Add Record',font='arial 20 bold',bg='green',fg='pink',width=10,command=add)
btn1.grid(row=0,column=0,padx=25,pady=7)

btn2=Button(F3,text='Save',font='arial 20 bold',bg='green',fg='pink',width=10,command=save)
btn2.grid(row=0,column=1,padx=25,pady=7)

btn3=Button(F3,text='Print',font='arial 20 bold',bg='green',fg='pink',width=10,command=print)
btn3.grid(row=0,column=2,padx=25,pady=7)

btn4=Button(F3,text='Reset',font='arial 20 bold',bg='green',fg='pink',width=10,command=reset)
btn4.grid(row=0,column=3,padx=25,pady=7)

btn5=Button(F3,text='Exit',font='arial 20 bold',bg='green',fg='pink',width=10,command=Exit)
